...
int council_roomFunction(struct gameState *state, int currentPlayer, int handPos){
   //+4 Cards
  int i;
      for (i = 0; i < 4; i++)
  {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return adventurerFunction(state, currentPlayer, drawntreasure, cardDrawn, z);
			
    case council_room:
			
      return council_roomFunction(state, currentPlayer, handPos);
    ...
    case smithy:
      return smithyFunction(state, currentPlayer, handPos);
    ...
    case baron:
      return baronFunction(state, currentPlayer, choice1);
    ...
    case ambassador:
      return ambassadorFunction(choice1, choice2, handPos, state, currentPlayer);
